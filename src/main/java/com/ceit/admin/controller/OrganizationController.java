...
public class OrganizationController {
    ...
    private String selectJsonData(Map<String, Object> reqBody, boolean singleObject) {
        String jsonData;
        ...
        if (singleObject)
            jsonData = sqlUtil.setTable(selectTableName)
    ...
    public Result treeData(Map<String, Object> reqBody) {
        ...
        String jsonData = selectJsonData(reqBody, false);
        return new Result("ok", 201, jsonData);
    }
    ...
    public Result pageData(Map<String, Object> reqBody) {
        ...
        if (totalcount < 0) {
            return new Result("Get Total Count Failed", 500, jsonData);
        }
    ...
    public Result getObject(Map<String, Object> reqBody) {
        ...
        String jsonData = selectJsonData(reqBody, true);
        return new Result("ok", 200, jsonData);
    }
